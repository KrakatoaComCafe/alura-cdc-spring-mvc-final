...
@RunWith(SpringJUnit4ClassRunner.class)//junit roda com spring
@ContextConfiguration(classes={JPAConfiguration.class, ProdutoDAO.class, DataSourceConfigurationTest.class})//classes que serão utilizadas no teste
@ActiveProfiles("test")
